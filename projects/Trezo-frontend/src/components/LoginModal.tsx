          ...
          >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full pl-10 pr-12 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            ...
            <div className="mt-6 text-center">
              <p className="text-white/60 text-sm">
                ...
                <button className="text-primary-400 hover:text-primary-300 font-medium" onClick={onSwitchToRegister}>
                  Sign up
                </button>
              </p>
            </div>
